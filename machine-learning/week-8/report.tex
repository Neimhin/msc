...
The aggregated precision, recall, and f1 scores don't reveal any further differences between the model architcuture's performances and are not reported here for brevity.
\begin{table}[h]
    \centering
    \begin{tabular}{|l|c|c|}
    \hline
