...
plt.suptitle('Stochastic Gradient Descent on $f_T(x)$ with various constant step-sizes sizes and $n=5$')

ax_f = fig.add_subplot(121)

for alpha in [1, 0.9, 0.8, 0.5, 0.1, 0.01, 0.001]:
    n = 5
    T = pd.read_csv("data/T.csv").values
